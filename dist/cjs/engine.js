...
function compareForSort(a, b, orderBy, options) {
    for (const order of orderBy) {
        let av = order.field.toUpperCase() === "SCORE" ? null : (0, utils_js_1.getPath)(a, order.field);
        let bv = order.field.toUpperCase() === "SCORE" ? null : (0, utils_js_1.getPath)(b, order.field);
