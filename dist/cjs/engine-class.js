    ...
    executeSearchIndices(query, options) {
        ...
        for (let i = 0; i < this.data.length; i++) {
            if (query.scoreNeeded) {
                ...
                if ((0, engine_js_1.evalExpr)(query.expr, this.data[i], options, i, scoreCtx)) {
                    indices.push(i);
        ...
        if (query.orderBy.length > 0) {
            ...
            sortHits.sort((a, b) => (0, engine_js_1.compareForSort)(a.item, b.item, query.orderBy, options, a.score, b.score));
